...
import { LayoutDashboard, Calendar, FileText, User, ClipboardList, UserCheck, Megaphone, LogOut, Clock } from 'lucide-react';
...
export function Topbar() {
  ...
  const menuItems = (user?.role === 'admin' || user?.role === 'chief_admin')
    ? [
        ...
        { label: 'Jam Shift',       href: '/admin/shift',           icon: Clock },
